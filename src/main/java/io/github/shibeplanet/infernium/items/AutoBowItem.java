...
public class AutoBowItem extends ProjectileWeaponItem implements Vanishable {
    private final double baseArrowDamage;
    private final float drawSpeed;

    public AutoBowItem(double baseArrowDamage, float drawSpeed, Properties properties) {
        super(properties);
        this.baseArrowDamage = baseArrowDamage;
        this.drawSpeed = drawSpeed;
    }

    public void onUseTick(Level p_40668_, LivingEntity p_40669_, ItemStack p_40667_,  int p_40670_) {
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if ((double)f == 1.0d) {
                    ...
                    if (!p_40668_.isClientSide) {
                        ...
                        abstractarrow.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0f, (float)f * 3.0f, 1.0f);
                        if (f == 1.0F) {
